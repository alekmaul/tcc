...
struct
{
    FIELDS1 unsigned int i : 5, j : 1, k : 16;
    FIELDS2
} c;
struct
{
...
#define T(n, pre, post, op)      \
    void fn1_##n(unsigned int x) \
    {                            \
        pre b.i post;            \
    }                            \
    void fn2_##n(unsigned int x) \
    {                            \
        pre b.j post;            \
    }                            \
    void fn3_##n(unsigned int x) \
    {                            \
        pre b.k post;            \
    }                            \
    void fn4_##n(unsigned int x) \
    {                            \
        pre c.i post;            \
    }                            \
    void fn5_##n(unsigned int x) \
    {                            \
        pre c.j post;            \
    }                            \
    void fn6_##n(unsigned int x) \
    {                            \
        pre c.k post;            \
    }                            \
    void fn7_##n(unsigned int x) \
    {                            \
        pre d.i post;            \
    }                            \
    void fn8_##n(unsigned int x) \
    {                            \
        pre d.j post;            \
    }                            \
    void fn9_##n(unsigned int x) \
    {                            \
        pre d.k post;            \
    }
