...
#define REPEAT_FN(COUNT)              \
    u8 CAT(lshiftrt_qi_, COUNT)(u8 n) \
    {                                 \
        return n >> COUNT;            \
    }
REPEAT_8
...
#define REPEAT_FN(COUNT)              \
    s8 CAT(ashiftrt_qi_, COUNT)(s8 n) \
    {                                 \
        return n >> COUNT;            \
    }
REPEAT_8
...
#define REPEAT_FN(COUNT)              \
    u16 CAT(ashift_hi_, COUNT)(u16 n) \
    {                                 \
        return n << COUNT;            \
    }
REPEAT_16
...
#define REPEAT_FN(COUNT)                \
    u16 CAT(lshiftrt_hi_, COUNT)(u16 n) \
    {                                   \
        return n >> COUNT;              \
    }
REPEAT_16
...
#define REPEAT_FN(COUNT)                \
    s16 CAT(ashiftrt_hi_, COUNT)(s16 n) \
    {                                   \
        return n >> COUNT;              \
    }
REPEAT_16
...
#define REPEAT_FN(COUNT)              \
    u32 CAT(ashift_si_, COUNT)(u32 n) \
    {                                 \
        return n << COUNT;            \
    }
REPEAT_32
...
#define REPEAT_FN(COUNT)                \
    u32 CAT(lshiftrt_si_, COUNT)(u32 n) \
    {                                   \
        return n >> COUNT;              \
    }
REPEAT_32
...
#define REPEAT_FN(COUNT)                \
    s32 CAT(ashiftrt_si_, COUNT)(s32 n) \
    {                                   \
        return n >> COUNT;              \
    }
REPEAT_32
