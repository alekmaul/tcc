...
#define NUMS16                                                                                    \
    {                                                                                             \
        0x0000U, 0x0001U, 0x8000U, 0x0002U, 0x4000U, 0x0100U, 0x0080U, 0xa5a5U, 0x5a5aU, 0xcafeU, \
            0xffffU                                                                               \
    }

#define NUMS32                                                                                  \
    {                                                                                           \
        0x00000000UL, 0x00000001UL, 0x80000000UL, 0x00000002UL, 0x40000000UL, 0x00010000UL,     \
            0x00008000UL, 0xa5a5a5a5UL, 0x5a5a5a5aUL, 0xcafe0000UL, 0x00cafe00UL, 0x0000cafeUL, \
            0xffffffffUL                                                                        \
    }
...
int main(void)
{
    ...
    for (i = 0; i < N(longlongs); i++) {
        if (__builtin_ffsll(longlongs[i]) != my_ffsll(longlongs[i]))
            abort();
        if (longlongs[i] != 0 && __builtin_clzll(longlongs[i]) != my_clzll(longlongs[i]))
            abort();
        if (longlongs[i] != 0 && __builtin_ctzll(longlongs[i]) != my_ctzll(longlongs[i]))
            abort();
