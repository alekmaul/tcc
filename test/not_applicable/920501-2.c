...
__ulonglong gcd_ll(__ulonglong x, __ulonglong y)
{
    for (;;) {
        if (y == 0)
...
__ulonglong powmod_ll(__ulonglong b, __ulonglong e, __ulonglong m)
{
    __ulonglong t;
    __ulonglong pow;
    __longlong i;
...
void facts(t, a_int, x0, p) __ulonglong t;
__longlong a_int;
__longlong x0;
__ulonglong p;
{
    ...
    if (t != 134217727 || a_int != -1 || x0 != 3 || p != 27)
        exit(5);
