...
__attribute__((noinline)) void check_float(int a,
                                           _Complex float a1,
                                           _Complex float a2,
                                           _Complex float a3,
                                           _Complex float a4,
...
__attribute__((noinline)) void check_double(int a,
                                            _Complex double a1,
                                            _Complex double a2,
                                            _Complex double a3,
                                            _Complex double a4,
...
__attribute__((noinline)) void check_long_double(int a,
                                                 _Complex long double a1,
