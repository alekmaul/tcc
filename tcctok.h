...
DEF(TOK___ashrdi3, "tcc__ashrdi3")
DEF(TOK___lshrdi3, "tcc__lshrdi3")
DEF(TOK___ashldi3, "tcc__ashldi3")
DEF(TOK___floatundisf, "tcc__floatundisf")
DEF(TOK___floatundixf, "tcc__floatundixf")
DEF(TOK___floatundidf, "tcc__floatundidf")
